...
# NEXT TWO STATEMENTS NEED TO BE CHANGED TO MATCH THE FINAL SETUP!!!
#set the default email sender and recipient 
email_sender = 'kritarth@gmail.com'
email_recipient = 'kritarth@gmail.com'
# detections_summary will be used to store the detections summary report
detections_summary = ''

classes_to_filter = None  #Can give list of classes to filter by name, 
# ----------------VERY IMPORTANT - CONFIGURATION PARAMETERS----------------
# a dictionary to store options for inference
opt  = {
    "weights": "best.pt", # Path to weights file default weights are for nano model; not provided on my github repo
